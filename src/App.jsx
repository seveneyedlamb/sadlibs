...
export default function AppAlt() {
    ...
    useEffect(() => {
        ...
        if ((ref.includes('hakurei.us-cdnbo.org') || ref.includes('news.ycombinator.com')) && !localStorage.getItem('4chanMode')) {
            setIs4ChanMode(true);
    ...
    return (
        <>
            ...
            <div className="av2-footer-share">
                <div className="share-scroll-bg" style={{ backgroundImage: `url(${logo})` }} aria-hidden="true" />
                <div className="share-scroll-bg share-scroll-bg-right" style={{ backgroundImage: `url(${logo})` }} aria-hidden="true" />
